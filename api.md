...
- <code title="post /boxes/{id}/android/apps/{packageName}/close-all">client.v1.boxes.android.<a href="./src/gbox_sdk/resources/v1/boxes/android.py">close_all</a>(package_name, \*, id) -> None</code>
