...
- <code title="delete /boxes/{id}">client.v1.boxes.<a href="./src/gbox_sdk/resources/v1/boxes/boxes.py">delete</a>(id) -> None</code>
...
- <code title="post /boxes/{id}/actions/press">client.v1.boxes.actions.<a href="./src/gbox_sdk/resources/v1/boxes/actions.py">press</a>(id, \*\*<a href="src/gbox_sdk/types/v1/boxes/action_press_params.py">params</a>) -> <a href="./src/gbox_sdk/types/v1/boxes/action_result.py">ActionResult</a></code>
