...
- <code title="post /boxes/{boxId}/browser/open">client.v1.boxes.browser.<a href="./src/gbox_sdk/resources/v1/boxes/browser.py">open</a>(box_id, \*\*<a href="src/gbox_sdk/types/v1/boxes/browser_open_params.py">params</a>) -> str</code>
