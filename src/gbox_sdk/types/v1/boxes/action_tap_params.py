...
__all__ = ["ActionTapParams", "Tap", "TapByNaturalLanguage", "TapByElement"]
...
class TapByElement(TypedDict, total=False):
...
ActionTapParams: TypeAlias = Union[Tap, TapByNaturalLanguage, TapByElement]
